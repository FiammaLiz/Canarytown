...
spiketimes_raw_all=[spiketimes_raw_P1F_VeNe2 spiketimes_raw_P1E_VeNe1 spiketimes_raw_P1F_VeNe1 spiketimes_raw_P1F2_RoNe1 spiketimes_raw_P1F1_RoNe1 spiketimes_raw_P1E2_RoNe1 spiketimes_raw_P1E1_RoNe1];
...
d(2)= subplot(5,1,2:3);
  ...
  line(spiketimes_raw_P1F1_RoNe1{1,k}(t)'*1000*[1 1],[-0.4 0.4] + k,'LineStyle','-','MarkerSize',15,'Color','b'); %extrae las instancias de disparo y hace lineas azules, apilándolas por cada trial 
        hold on
        end 
    end 
  ...
  line(spiketimes_raw_P1E1_RoNe1{1,i}(t)'*1000*[1 1],[-0.4 0.4]+ i + k,'LineStyle','-','MarkerSize',15,'Color',[0,0.3882,0]); %extrae las instancias de disparo y hace lineas azules, apilándolas por cada trial 
         end 
     end 
     
     for m=1:length(spiketimes_raw_P1E1_RoNe1) 
         for t=1:length(spiketimes_raw_P1E1_RoNe1{1,m})
  line(spiketimes_raw_P1E1_RoNe1{1,m}(t)'*1000*[1 1],[-0.4 0.4]+ m + i + k,'LineStyle','-','MarkerSize',15,'Color',[1,0.3,0]); %extrae las instancias de disparo y hace lineas azules, apilándolas por cada trial 
         end 
     end 
     
     for n=1:length(spiketimes_raw_P1E2_RoNe1) 
         for t=1:length(spiketimes_raw_P1E2_RoNe1{1,n})
  line(spiketimes_raw_P1E2_RoNe1{1,n}(t)'*1000*[1 1],[-0.4 0.4]+ n + m + i + k,'LineStyle','-','MarkerSize',15,'Color','k'); %extrae las instancias de disparo y hace lineas azules, apilándolas por cada trial 
         end 
     end 
 ...
 line([0 larg_m],[0.5 0.5] + k + i + m + n,'LineStyle','-','MarkerSize',4,'Color','k');
  ...
  line(spiketimes_raw_P1E_VeNe1{1,o}(t)'*1000*[1 1],[-0.4 0.4]+ o + n + m + i + k,'LineStyle','-','MarkerSize',15,'Color',[0 1 1]); %extrae las instancias de disparo y hace lineas azules, apilándolas por cada trial 
         end 
     end 
    
       for p=1:length(spiketimes_raw_P1F_VeNe1) 
         for t=1:length(spiketimes_raw_P1F_VeNe1{1,p})
  line(spiketimes_raw_P1F_VeNe1{1,p}(t)'*1000*[1 1],[-0.4 0.4]+ p + o + n + m + i + k,'LineStyle','-','MarkerSize',15,'Color',[1 0 0.5]); %extrae las instancias de disparo y hace lineas azules, apilándolas por cada trial 
         end 
       end 


       for q=1:length(spiketimes_raw_P1F_VeNe2) 
         for t=1:length(spiketimes_raw_P1F_VeNe2{1,q})
  line(spiketimes_raw_P1F_VeNe2{1,q}(t)'*1000*[1 1],[-0.4 0.4]+ q + p + o + n + m + i + k,'LineStyle','-','MarkerSize',15,'Color',[0.5 0 1]); %extrae las instancias de disparo y hace lineas azules, apilándolas por cada trial 
         end 
       end 
...
hist_spikes_P1F_VeNe2= cell2mat(spiketimes_raw_P1F_VeNe2)*1000;
[f33,x33]=ksdensity(hist_spikes_P1F_VeNe2,'BandWidth',binsize,'function','pdf'); %funcion de suavizado
