...
spiketimes_raw_all=[spiketimes_raw_trial_P1F1_RoNeS5 spiketimes_raw_trial_P1K_RoNeS2 spiketimes_raw_trial_P1E2_RoNeS2 spiketimes_raw_trial_P1E1_RoNeS2 spiketimes_raw_trial_P1H_VeNeS3 spiketimes_raw_trial_P1G_VeNeS3 spiketimes_raw_trial_P1F_VeNeS3];
...
for i=1:length(spiketimes_raw_all)
 [hh,tt]=ksdensity(spiketimes_raw_all{1,i}*1000,0:0.3:larg_m,'BandWidth',binsize,'function','pdf');
 hold on
 cs=vertcat(cs,hh);
 plot(tt,cs(i,:))
end
...
plot(x33,f33,'LineWidth',1,'Color',[0.5 0 1]);
...
plot(x2x33,f2f33,'LineWidth',1,'Color',[0.5 0.8 0]);
...
plot(xx2x3,ff2f3,'LineWidth',1,'Color',[0.5 0.5 0.5]);
