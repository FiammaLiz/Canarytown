...
%raster e histograma
%Utiliza como entrada datos cargados de salida de clustering, ordenados en
%script Rastercluster
%Matlab 2017a
%Fiamma Liz Leites
...
%% ESTIMULO, RASTER E HISTOGRAMA
 ...
 %Si hay mas de un estímulo, saca una figura por cada estimulo
    ...
    for n=1:(length(unique(num_stim)))  %para cada estimulo
        ...
        hold off
        ylabel ({'Espectograma';'Frecuencia (Hz)'});
        ...
        % num_points=pausa/binsize*1000 %otro modo de puntos para suavizado
         ...
         ylabel ({'Tasa de'; 'disparo relativa'});
