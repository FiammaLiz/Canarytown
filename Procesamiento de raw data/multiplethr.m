...
thr_m=(-100:10:-30); %umbrales que quiero abarcar
maximo= 500; %tama�o del shoulder de arriba
minimo= -1000; %tama�o del spike, para eliminar artefactos de t�cnica para spike shape
...
for i=1:length(thr_m) %para todos los umbrales
    [spike_lcs, spike_times, spike_tot, s, ntrials, duracion_stim, L, spike_stim, spike_lcs_ss]=spikedetection (maximo,minimo,thr_m(i), channel_neural_data, sample_rate, num_stim, t0s, t_audio_stim, pausa); %levanto los spikes
