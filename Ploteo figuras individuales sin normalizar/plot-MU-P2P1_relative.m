...
%promedio de datos de P1, MUA, normalizadas

load('D:\Datos Canarios Protocolos\Data procesada\spiketimesrelative-MU-P1')
...
d(2)= subplot(5,1,2:3);
  ...
  line(spiketimes_relative_P1E2_RoNe1{1,n}(t)'*[1 1],[-0.4 0.4]+ n + m + i + k,'LineStyle','-','MarkerSize',15,'Color','k'); %extrae las instancias de disparo y hace lineas azules, apilándolas por cada trial 
     ...
     line([0 1],[0.5 0.5] + k + i + m + n,'LineStyle','-','MarkerSize',4,'Color','k');
...
ylabel ({'Curvas de'; 'suavizado';'por frase'}),
